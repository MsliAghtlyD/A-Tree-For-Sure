...
addLayer('t', {
    ...
    upgrades:{
        ...
        52:{
            ...
            cost() { if (hasAchievement('a', 53)) return new Decimal("1e30008") 
...
addLayer(`g`, {
    ...
    upgrades: {
        ...
        12:{ 
            ...
            description() {if (player.g.unlocked) return `Unlock this layer's ugprades.<br><i><b>They</b> will apparently let you have some help. But at a cost, how dastardly</i>`
                return `Unlock this layer's effect.`
            },
            fullDisplay() {return `<h3>`+this.title+`</h3><br>`+tmp[this.layer].upgrades[this.id].description+`<br><br>Requires: `+ this.cost+` Global conspiracies`},
            cost: new Decimal(5),
  ...
  /*      11: {
            ...
            challengeDescription: `Get a taste of the same reality`,
            goalDescription:`get 5 Global Conspiracies`,
            rewardDescription:`Theory layer's boost's formula is much more generous`,
            canComplete: function() {return player.g.points.gte(5)},
            unlocked() {return(hasUpgrade('g', 12)) },
            onComplete(){player.g.points = player.g.points.minus(5)},
      },*/
